...
void Change::Capture(Parameters& P)
{
    ...
    ParamCapture(dEvw,    PDiscrete) // Evw -> I rate
    ...
    ParamCapture(uvw,     PVector) //Susceptibility after 1 dose waned
    ...
    ParamCapture(yvw,     PVector) // clinical fraction after 1 dose waned
